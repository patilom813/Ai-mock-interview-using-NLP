...
const Interview = ({ params }) => {
  ...
  const handleDeletePreviousResponse = async (interviewId) => {
    try {
    ...
    <div className="my-10">
      ...
      <div className="flex justify-center my-4 md:my-0 md:justify-end md:items-end">
        <Link href={"/dashboard/interview/" + params.interviewId + "/start"}>
          <Button onClick={() => handleDeletePreviousResponse(params.interviewId)} disabled={!webCamEnabled} >Start Interview</Button>
        </Link>
      </div>
    </div>
  );
