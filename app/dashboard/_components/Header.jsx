      ...
      <div className="w-[80%] m-auto flex gap-4 items-center justify-between">
        ...
        <ul className="hidden md:flex gap-6">
          ...
          {/* <Link href="/dashboard/upgrade">
            <li
              className={`hover:text-black hover:font-bold transition-all cursor-pointer ${path == "/dashboard/upgrade" && "text-black font-bold"
                }`}
            >
              Upgrade
            </li>
          ...
          <Link href="/dashboard/hr-interview">
            <li
              className={`hover:text-black hover:font-bold transition-all cursor-pointer ${path == "/dashboard/hr-interview" && "text-black font-bold"
                }`}
            >
              HR Interview
            </li>
